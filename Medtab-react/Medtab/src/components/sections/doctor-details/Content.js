                                        ...
                                        <div className="row no-gutters">
                                            <div className="col-md-4">
                                                <div className="menu nav-item">
                                                    <Link to="#" className="nav-link active p-0" onClick={() => document.getElementById("overview").scrollIntoView({ behavior: 'smooth' })}>Descripción</Link>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="menu nav-item">
                                                    <Link to="#" className="nav-link p-0" onClick={() => document.getElementById('contact').scrollIntoView({ behavior: 'smooth' })}>Ubicacion &amp; Contacto</Link>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="menu nav-item border-0">
                                                    <Link to="#" className="nav-link p-0" onClick={() => document.getElementById('reviews').scrollIntoView({ behavior: 'smooth' })}>Reseñas</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="overview">
                                        <h4>Descripcion general de {item.name}</h4>
                                        <div dangerouslySetInnerHTML={{ __html: item.htmltext }} />
                                    </div>
                                    <div className="spacer">
                                    </div>
                                    <div id="contact">
                                        <h4>{item.name} ubicación e información de contacto</h4>
                                        <div className="sigma_contact-wrapper">
                                            <div className="sigma_contact-map">
                                                <iframe title={item.name} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3403.975860563968!2d-64.20174002360993!3d-31.442331497507386!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9432a25925957c33%3A0xcbc974304cd4e547!2sHospital%20Privado%20Universitario%20de%20C%C3%B3rdoba!5e0!3m2!1ses-419!2sar!4v1692395865251!5m2!1ses-419!2sar" height={600} allowFullScreen>
                                                </iframe>
                                            </div>
                                            <div className="sigma_contact-blocks">
                                                <h5>Direccion del hospital</h5>
                                                <div className="row">
                                                    <div className="col-md-4">
