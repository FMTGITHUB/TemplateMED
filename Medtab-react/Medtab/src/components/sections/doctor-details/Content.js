                        ...
                        <div className="col-lg-8">
                            <div className="sigma_post-details-inner">
                                <div className="entry-content">
                                        ...
                                        <div className="row no-gutters">
                                            ...
                                            <div className="col-md-4">
                                                <div className="menu nav-item border-0">
                                                    <Link to="#" className="nav-link p-0" onClick={() => document.getElementById('reviews').scrollIntoView({ behavior: 'smooth' })}></Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="contact">
                                        <h4>{item.name} Ubicacion &amp; Informacion de Contacto</h4>
