                        ...
                        <div className="col-lg-8">
                            <div className="sigma_post-details-inner">
                                <div className="entry-content">
                                        ...
                                        <div className="row no-gutters">
                                            <div className="col-md-4">
                                                <div className="menu nav-item">
                                                    <Link to="#" className="nav-link active p-0" onClick={() => document.getElementById("overview").scrollIntoView({behavior: 'smooth'})}>Descripción general</Link>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="menu nav-item">
                                                    <Link to="#" className="nav-link p-0" onClick={() => document.getElementById('contact').scrollIntoView({behavior: 'smooth'})}>Ubicación &amp; Contacto</Link>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                    ...
                                    <div id="overview">
                                        <h4>Descripción general de {item.name}</h4>
                                    ...
                                    <div id="reviews">
                                        <h4>Experiencias de pacientes</h4>
                                        {/* Data */}
